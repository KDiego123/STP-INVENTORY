...
class SolicitudEquipo(Base):
    ...
    rechazado_por_usuario_id: Mapped[int | None] = mapped_column(BigInteger)
    rechazado_por_nombre: Mapped[str | None] = mapped_column(String(150))
    fecha_rechazo: Mapped[datetime | None] = mapped_column(DateTime(timezone=True))
